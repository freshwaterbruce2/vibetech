...
.EXAMPLE
    .\Monitor-TradingBot-Clean.ps1
    Standard monitoring with defaults

.EXAMPLE
    .\Monitor-TradingBot-Clean.ps1 -CheckIntervalSeconds 30 -NoTradeAlertMinutes 15
...
Write-Host "Checking BurntToast module..." -ForegroundColor Cyan
