  ...
  const services = [
    {
      ...
      icon: <Code className="h-10 w-10 text-[color:var(--c-cyan)]" />,
    ...
    },
    {
      ...
      icon: <Globe className="h-10 w-10 text-[color:var(--c-purple)]" />,
    ...
    },
    {
      ...
      icon: <Tag className="h-10 w-10 text-[color:var(--c-teal)]" />,
  ...
  return (
    <section className="py-16 px-4 bg-aura-backgroundLight/30">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-12 text-center font-heading gradient-text-full">Our Services</h2>
