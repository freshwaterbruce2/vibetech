      ...
      <div className="glass-card mx-auto max-w-6xl px-6 py-10 lg:flex lg:items-center relative z-10 border border-[color:var(--c-secondary)/20] hover:border-[color:var(--c-secondary)/40] hover:shadow-neon-purple-soft">
        ...
        <div className="w-full md:w-2/3 md:pl-12">
          <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-4 tracking-tight">
            Hello! I'm <span className="gradient-text-full">Bruce Freshwater</span>
          </h1>
          <div className="mb-6 flex items-center">
            <span className="text-2xl md:text-3xl font-semibold">
              I'm a <span className="text-[color:var(--c-primary)]">Software Engineer</span>
            </span>
          ...
          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-3 text-[color:var(--c-primary)]">Get in touch</h3>
            <SmartLeadForm 
              variant="inline" 
