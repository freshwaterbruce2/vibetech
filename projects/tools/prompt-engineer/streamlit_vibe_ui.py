...
def main():
    ...
    with tab1:
        analyze_project_tab(project_path, max_files, include_code, include_git, include_docs)
...
def analyze_project_tab(project_path, max_files, include_code, include_git, include_docs):
